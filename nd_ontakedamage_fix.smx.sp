...
{
	HookEvent("player_changeclass", Event_BlockGizmo, EventHookMode:0);
	HookEvent("player_spawn", Event_BlockGizmo, EventHookMode:0);
	return 0;
}

public Action:Event_BlockGizmo(Handle:event, String:name[], bool:dontBroadcast)
{
	new client = GetClientOfUserId(GetEventInt(event, "userid"));
	if (NDC_IsCommander(client))
	{
		SetEntProp(client, PropType:0, "m_iActiveGizmo", any:0, 4, 0);
